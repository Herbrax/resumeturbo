...
\name{Emily}{Chen}
\address{2564 Brothers Avenue, Toronto, ON, M5O 5K5, Canada}
\begin{document}
\makecvtitle
\vspace*{-23mm}
\begin{center}
\begin{tabular}{ c c c c }
\faLanguage\enspace English, Mandarin & \faEnvelopeO\enspace emily.chen@email.com & \faGithub\enspace \href{https://github.com/emilychen}{} & \faMobile\enspace +1 (555) 123-4567  \\
\end{tabular}
\end{center}
...
\textbf{Data Analysis:} Machine Learning, Data Visualization, Big Data\\
\textbf{Tools:} Tableau, Power BI, Excel, Jupyter\\
\textbf{Miscellaneous:} Git, Data Mining, Predictive Modeling, Agile

\section{EDUCATION}
\customcventry{2018 - 2022}{B.Sc. in Data Science}{University of Toronto}{Toronto, ON}{}{Graduated with honors, focusing on statistical methods and data analysis.}
\customcventry{2020 - 2021}{Diploma in Big Data Analytics}{Humber College}{Toronto, ON}{}{Concentrated on big data technologies and applications.}
...
\section{PROJECTS}
\customcvproject{Sales Data Analysis}{2021}{}{
    \begin{itemize}
...
\customcvproject{Customer Segmentation Study}{2022}{}{
    \begin{itemize}
